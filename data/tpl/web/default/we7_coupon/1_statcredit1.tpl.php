...
<ul class="nav nav-tabs">
	<li <?php  if($op == 'index') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWeburl('statcredit1', array('op' => 'index'))?>">积分日志</a></li>
	<li <?php  if($op == 'chart') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWeburl('statcredit1', array('op' => 'chart'))?>">积分统计</a></li>
</ul>
<?php  if($op == 'chart') { ?>
	...
	<div class="panel-body" id="scroll">
		<div class="pull-left">
			<form action="" id="form1">
				...
				<input type="hidden" name="do" value="statcredit1">
