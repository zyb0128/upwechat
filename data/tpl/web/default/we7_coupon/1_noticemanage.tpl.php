	...
	<form action="" method="post" class="form-horizontal" role="form">
		<div class="form-group">
			<div class="col-sm-8 col-lg-9 col-xs-12">
				<a href="<?php  echo $this->createWeburl('noticemanage', array('op' => 'post'));?>" class="btn btn-success"><i class="fa fa-plus"></i> 发布通知</a>
			</div>
		</div>
		<div class="panel panel-default">
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td class="text-right">
							<a href="<?php  echo $this->createWeburl('noticemanage', array('op' => 'post', 'id' => $notice['id']));?>" class="btn btn-default">编辑</a>
							<a href="<?php  echo $this->createWeburl('noticemanage', array('op' => 'del', 'id' => $notice['id']));?>" onclick="if(!confirm('确定删除吗')) return false;" class="btn btn-default">删除</a>
						</td>
					</tr>
					<?php  } } ?>
					</tbody>
