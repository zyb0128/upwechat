...
<ul class="nav nav-tabs">
	<li <?php  if($op == 'index') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWeburl('statcredit2', array('op' => 'index'))?>">余额日志</a></li>
	<li <?php  if($op == 'chart') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWeburl('statcredit2', array('op' => 'chart'))?>">余额统计</a></li>
</ul>
<?php  if($op == 'chart') { ?>
